...
count_vector = pk.load(open('data\\count_vector.pkl','rb'))            # Count Vectorizer
tfidf_transformer = pk.load(open('data\\tfidf_transformer.pkl','rb')) # TFIDF Transformer
model = pk.load(open('data\\model.pkl','rb'))                          # Classification Model
recommend_matrix = pk.load(open('data\\user_final_rating.pkl','rb'))   # User-User Recommendation System 
...
def recommend_products(user_name):
    recommend_matrix = pk.load(open('data\\user_final_rating.pkl','rb'))
